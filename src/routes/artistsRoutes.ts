...
import { register, login, profile, update, getAllAppointmentByArtistId, getAllArtist, getAllClients, updateAdmin, updateAdminClients } from "../controllers/artistsController";
